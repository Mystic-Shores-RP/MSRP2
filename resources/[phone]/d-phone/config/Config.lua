...
Config.OpenPhonekey = "M"           -- The control key used to open the phone e.g. "m"
...
Config.OxInventory = true -- Enable this, if youre using oxinventory

-- Phone Command Settings
Config.Command = false        -- Set to true to enable the phone command
...
Config.PMAVoice = true     -- Set to true if using PMAVOICE (requires OneSync enabled and at least the $15 Patreon subscription)
...
-- Database Settings
Config.oxmysql = true                 -- Set to true if using oxmysql
